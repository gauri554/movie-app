          ...
          <aside className="col-span-4">
            <div className="rounded-xl overflow-hidden shadow-lg bg-gradient-to-b from-[#233e6a] to-[#1b2b4a]">
              ...
              <div className="p-5">
                ...
                <div className="flex items-center gap-3 mt-3">
                  ...
                  <button className="ml-auto bg-yellow-400 text-black px-3 py-1 rounded-full font-semibold">Rate Now</button>
                </div>
                ...
                <button className="w-full mt-6 bg-pink-500 hover:bg-pink-600 text-white py-3 rounded-xl font-semibold">Enquiry Now</button>
            </Link>
              </div>
            </div>
            ...
            <div className="mt-6 space-y-4">
              ...
              <div className="p-4 rounded-xl bg-white/5">
                ...
                <button className="mt-3 text-sm text-pink-400 underline">Tap to view details</button>
              </div>
            </div>
          </aside>
            ...
            <section className="mb-6 flex items-center gap-6">
              <div className="flex-1 p-4 rounded-xl bg-[#11243b] shadow-md">
                <div className="flex items-center justify-between">
                  ...
                  <button className="bg-yellow-400 text-black px-4 py-2 rounded-full font-semibold">Rate Now</button>
                </div>
              </div>
              ...
              <div className="w-64 p-4 rounded-xl bg-[#11243b]">
                ...
                <div className="mt-2 flex gap-2">
                  <span className="px-3 py-1 bg-white/6 rounded-full text-sm">#Blockbuster 101</span>
                  <span className="px-3 py-1 bg-white/6 rounded-full text-sm">#Awesome Story 101</span>
                </div>
              </div>
            </section>
              ...
              <div className="grid grid-cols-3 gap-6">
                {cast.map((c) => (
                  <div key={c.name} className="flex flex-col items-center gap-2">
                    <img src={c.img} alt={c.name} className="w-48 h-48 rounded-full object-cover border-2 border-white/10" />
